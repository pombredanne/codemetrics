...
public interface JavaListener extends ParseTreeListener {
	...
	void enterSynchronizedExpression(JavaParser.SynchronizedExpressionContext ctx);
	void exitSynchronizedExpression(JavaParser.SynchronizedExpressionContext ctx);
	...
	void enterThrowExpression(JavaParser.ThrowExpressionContext ctx);
	void exitThrowExpression(JavaParser.ThrowExpressionContext ctx);
	...
	void enterTryExpression(JavaParser.TryExpressionContext ctx);
	void exitTryExpression(JavaParser.TryExpressionContext ctx);
	...
	void enterForExpression(JavaParser.ForExpressionContext ctx);
	void exitForExpression(JavaParser.ForExpressionContext ctx);
	...
	void enterDoWhileExpression(JavaParser.DoWhileExpressionContext ctx);
	void exitDoWhileExpression(JavaParser.DoWhileExpressionContext ctx);
	...
	void enterBreakExpression(JavaParser.BreakExpressionContext ctx);
	void exitBreakExpression(JavaParser.BreakExpressionContext ctx);
	...
	void enterContinueExpression(JavaParser.ContinueExpressionContext ctx);
	void exitContinueExpression(JavaParser.ContinueExpressionContext ctx);
	...
	void enterWhileExpression(JavaParser.WhileExpressionContext ctx);
	void exitWhileExpression(JavaParser.WhileExpressionContext ctx);
	...
	void enterReturnExpression(JavaParser.ReturnExpressionContext ctx);
	void exitReturnExpression(JavaParser.ReturnExpressionContext ctx);
